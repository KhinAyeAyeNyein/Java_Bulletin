        ...
        <div class="forms-mr">
          <div class="col-sm-6 col-md-6 form-detail">
            ...
            <form:form class="form-create" action="${addAction}"
              ModelAttribute="updatePostForm" method="post" id="form">
                ...
                <div class="card-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item"><b>Status</b> <c:if
                        test="${updatePostForm.status == '0' }">
                        <a class="float-right">OFF <input
                          type="hidden" name="status"
                          value="${updatePostForm.status }"
                          class="form-control" />
                        </a>
                      </c:if> <c:if test="${updatePostForm.status == '1' }">
                        <a class="float-right">ON <input
                          type="hidden" name="status"
                          value="${updatePostForm.status }"
                          class="form-control" />
                        </a>
